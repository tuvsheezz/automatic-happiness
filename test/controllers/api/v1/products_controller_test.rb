...
class Api::V1::ProductsControllerTest < ActionDispatch::IntegrationTest
  setup do
    ...
    @user2 = User.create! email: Faker::Internet.email, password_digest: Faker::Alphanumeric.alphanumeric(number: 10)
  ...
  test 'should forbid update other\'s product' do
    patch api_v1_product_url(@product), params: { product: { title: @product.title } }, headers: { Authorization: JsonWebToken.encode(user_id: @user2.id) }, as: :json
    assert_response :forbidden
  end
  ...
  test "should forbid destroy product" do
    assert_no_difference('Product.count') do
      delete api_v1_user_url(@product), headers: { Authorization: JsonWebToken.encode(user_id: @user2.id) }, as: :json
    end
    assert_response :forbidden
  end
end
